...
def parse_opt():
    ...
    parser.add_argument("--model","-m", type=str, choices=["dinov2_vitl14_reg", "dinov2_vitl14", "inceptionv4", "eva02L"], default="dinov2_vitl14", help="model type")
    ...
    parser.add_argument("--warmup_epochs", "-we", type=int, default=10, help="number of warmup epochs")  
