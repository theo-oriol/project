...
def startup_dir(name,habitat):
    ...
    i=0
    while os.path.isdir(os.path.join("results",f"{name}_{habitat}_{i}")) : i+=1
    destination_dir = os.path.join("results",f"{name}_{habitat}_{i}")
